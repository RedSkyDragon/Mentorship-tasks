...
namespace ThingsBook.BusinessLogic.Tests
{
    ...
    public class UsersBLTests
    {
        ...
        {           
            ...
            _users
                .Setup(t => t.CreateUser(It.IsAny<User>()))
                .Returns(Task.CompletedTask);
            _users
                .Setup(t => t.UpdateUser(It.IsAny<User>()))
                .Returns(Task.CompletedTask);
            _users
                .Setup(t => t.DeleteUser(It.IsAny<Guid>()))
                .Returns(Task.CompletedTask);
            _users
                .Setup(t => t.GetUser(It.IsAny<Guid>()))
            ...
            _history
                .Setup(h => h.DeleteUserHistory(It.IsAny<Guid>()))
                .Returns(Task.CompletedTask);
            ...
            _things
                .Setup(t => t.DeleteThings(It.IsAny<Guid>()))
                .Returns(Task.CompletedTask);
        ...
        public async Task CreateUserTest()
        {
            ...
            Assert.ThrowsAsync<ArgumentNullException>(() => _usersBL.Create(null));
        ...
        public async Task UpdateUserTest()
        {
            ...
            Assert.NotNull(result);
            Assert.AreEqual(user.Id, result.Id);
            Assert.ThrowsAsync<ArgumentNullException>(() => _usersBL.Update(null));
        ...
        public async Task CreateOrUpdateUserTest()
        {
            ...
            Assert.NotNull(result);
            Assert.AreEqual(user.Id, result.Id);
            Assert.ThrowsAsync<ArgumentNullException>(() => _usersBL.CreateOrUpdate(null));
